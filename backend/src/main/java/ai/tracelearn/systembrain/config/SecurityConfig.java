    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // /ws/** HTTP upgrade handshake is permitted so the WebSocket
                        // connection can be established. Actual authentication is enforced
                        // at the STOMP protocol layer by WebSocketAuthChannelInterceptor —
                        // no STOMP session can proceed without a valid JWT on CONNECT.
