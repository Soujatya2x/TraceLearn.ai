...
public class SecurityConfig {
    ...
    private final CustomOidcUserService customOidcUserService; // ← added
        ...
        http
                ...
                .oauth2Login(oauth2 -> oauth2
                        ...
                        .userInfoEndpoint(userInfo -> {
                            userInfo.userService(customOAuth2UserService); // GitHub — plain OAuth2
                            userInfo.oidcUserService(customOidcUserService); // Google — OIDC ← added
                        })
