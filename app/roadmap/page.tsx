...
// ─── Mock data — shown when AI agent /ai/roadmap not yet implemented ──────────
...
const MOCK_ROADMAP: LearningRoadmap = {
  ...
  recommendedTopics: [
    {
      id: 'rt-1', title: 'Understanding try/except in Python',
      description: 'Learn how to catch specific exception types, use finally blocks, and raise custom exceptions.',
      estimatedMinutes: 25, priority: 'high', category: 'Error Handling',
      resourceLinks: [
    ...
    {
      id: 'rt-2', title: 'Async/Await & Event Loop Fundamentals',
      description: 'Understand cooperative multitasking, async def, await expressions, and the event loop.',
      estimatedMinutes: 40, priority: 'high', category: 'Async',
      resourceLinks: [
    ...
    {
      id: 'rt-3', title: 'Big-O Notation & Algorithm Analysis',
      description: 'Master time and space complexity analysis to write efficient code.',
      estimatedMinutes: 30, priority: 'high', category: 'Algorithms',
      resourceLinks: [{ title: 'Big-O Cheat Sheet', url: 'https://www.bigocheatsheet.com/', type: 'article', source: 'bigocheatsheet.com' }],
    },
    {
      id: 'rt-4', title: 'Python Class Design & Inheritance',
      description: 'Go beyond basic classes to explore inheritance, polymorphism, and dunder methods.',
      estimatedMinutes: 35, priority: 'medium', category: 'OOP',
      resourceLinks: [{ title: 'OOP in Python', url: 'https://realpython.com/python3-object-oriented-programming/', type: 'tutorial', source: 'realpython.com' }],
    },
    {
      id: 'rt-5', title: 'List Comprehensions & Generator Expressions',
      description: 'Write idiomatic Python using list/dict/set comprehensions and memory-efficient generators.',
      estimatedMinutes: 20, priority: 'medium', category: 'Data Structures',
      resourceLinks: [{ title: 'Comprehensions Guide', url: 'https://realpython.com/list-comprehension-python/', type: 'article', source: 'realpython.com' }],
    },
    {
      id: 'rt-6', title: 'Recursion & Memoization Patterns',
      description: 'Understand the call stack, base/recursive cases, and caching with memoization.',
      estimatedMinutes: 30, priority: 'low', category: 'Algorithms',
      resourceLinks: [],
    },
  ],
  nextSteps: [
    {
      id: 'ns-1', action: 'Fix your Async patterns first',
      description: 'With 8 async errors, this is your highest-impact area.',
      resourceLinks: [{ title: 'asyncio Quickstart', url: 'https://docs.python.org/3/library/asyncio-task.html', type: 'documentation', source: 'python.org' }],
      practiceExercises: [
    ...
    {
      id: 'ns-2', action: 'Add error guards to your existing code',
      description: 'Review your recent sessions and add proper try/except blocks everywhere.',
      resourceLinks: [{ title: 'LBYL vs EAFP', url: 'https://realpython.com/python-lbyl-vs-eafp/', type: 'article', source: 'realpython.com' }],
      practiceExercises: [
    ...
    {
      id: 'ns-3', action: 'Solve 5 easy algorithm problems on LeetCode',
      description: 'Reinforce algorithm knowledge with foundational problems.',
      resourceLinks: [
      ...
      practiceExercises: ['Two Sum (LeetCode #1)', 'Valid Parentheses (LeetCode #20)', 'Reverse Linked List (LeetCode #206)'],
    },
  ],
}
...
export default function RoadmapPage() {
  ...
  // ── Real data: GET /api/v1/roadmap/{userId} ────────────────────────────────
  // Calls OrchestrationService.generateRoadmap → AI agent /ai/roadmap
  // If userId is null (not logged in) or AI agent endpoint missing → fallback.
  const roadmapQuery = useRoadmap(userId)
  const { data: roadmap, isPreview, isLoading } = useFallback(roadmapQuery, MOCK_ROADMAP)
    ...
    return (
      <AppShell activeNav="roadmap">
        <div className="px-6 py-8 max-w-6xl mx-auto">
          <RoadmapSkeletonLoader isPreview={isPreview} />
        </div>
      </AppShell>
    )
  }
          ...
          <p className="text-xs text-muted-foreground">
            ...
            {isPreview && (
              <span className="text-primary">
                Showing demo data — complete a session to see your personalized roadmap.
              </span>
            )}
          </p>
        </div>
